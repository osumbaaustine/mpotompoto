...
class Config extends Secure_Controller
{
	...
	/*
	 * This function loads all the licenses starting with the first one being TK POS one
	 */
	private function _licenses()
	{
		...
		{
			$license[$i]['text'] = 'LICENSE file must be in TK POS license directory. You are not allowed to use TK POS application until the distribution copy of LICENSE file is present.';
		}
